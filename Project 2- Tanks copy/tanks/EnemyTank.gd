...
#if something enters its detect radius, it shoots at it
func _on_DetectRadius_body_entered(body):   # assigned a target as anythign that has a detect radius, like obstacles
	target = body
